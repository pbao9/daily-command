...
export function RichTextEditor({ content, onChange, placeholder = 'Add more details...' }: RichTextEditorProps) {
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          'min-h-20 max-h-48 overflow-y-auto px-3 py-2 text-sm text-foreground outline-none [&_p]:my-1 [&_ul]:my-1 [&_ul]:list-disc [&_ul]:pl-5',
